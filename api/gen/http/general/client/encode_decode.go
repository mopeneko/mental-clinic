...
//
// general HTTP client encoders and decoders
//
// Command:
...
// path set to call the "general" service "healthCheck" endpoint
func (c *Client) BuildHealthCheckRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: HealthCheckGeneralPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("general", "healthCheck", u.String(), err)
	}
	if ctx != nil {
...
// general healthCheck endpoint. restoreBody controls whether the response body
